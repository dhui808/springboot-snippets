...
/**
 * Option 4 for enabling Spring Cache.
 *
 * Similar to Option 2, except that here we use classes = {SpringBootCachingApplication.class}.
 */
@SpringBootTest(classes = {SpringBootCachingApplication.class})
class ProductServiceWithClassesAttributeTest {
